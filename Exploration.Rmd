...
ggplot(data = data, aes(x = data$bwght)) + geom_histogram(bins = 50, fill="dodgerblue1", colour = "black") +
  ggtitle('Distribution of Baby Birthweight') + xlab("Baby Birthweight (in grams)") +
...
>>>>>>> a812c632efd16f540229223aad105edb102aba92
