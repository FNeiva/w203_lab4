...
Other demographic variables play a role in the health of an infant, but deciphering their meaning is not so straightforward. For instance, we found that the father's age has a positive influence in the baby's birthweight, but it is unlikely that this is a direct relationship especially because it goes against the logic. What is most likely is that older fathers probably have waited until achieving some financial stability or professional success before having a child, and therefore were able to provide for the family while the mother is dedicated to her pregnancy and prenatal care. It is also possible that older fathers already had other children, and therefore have better knowledge on pregnancy and prenatal care best practices.

All of those are variables that would be interesting to look at and understand the whole scenario on a newborn's health, which are now probably being accounted in the error term. Also, the omission of such important variables may be causing omitted variable bias in the previously regressed models and hence causing the coefficients to also be highly biased.
