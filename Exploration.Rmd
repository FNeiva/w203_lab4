...
The table below displays a comparison between all three models developed in this report. All standard errors have been calculated using heteroskedastic-robust methods. 
...
When we add in our control variables in the second model, we clearly witness 
